/* If you have your sample database, ignore lines 4 - 88 and go to its folder, then in Terminal type the following command,
it should open the DB in SQLite, then to query data from the database, you can write SQL queries from line 93 directly in the sqlite> prompt. */
